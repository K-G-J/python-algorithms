...
Find the shortest path from a start vertex to a target vertex in the graph.

Time Complexity: The runtime of A* is O(bd) where b is the branching factor of the graph and d is the depth of the goal vertex from the start vertex.
